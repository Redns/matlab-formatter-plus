...
为 Visual Studio Code 设计的 MATLAB / Octave 代码格式化插件，基于 [matlab-formatter-vscode](https://github.com/affenwiesel/matlab-formatter-vscode) 修改，相较原版具有如下特性

- 完全基于 js 实现，**移除 python 环境依赖**
- 新增 **end/=/注释对齐、空行插入、强制空行移除、分号自动添加/移除** 等功能，详细效果见下文 **配置说明**
...
|              **Remove Unnecessary Semicolons**               |                  **Force Split Statements**                  |               **Align Assignments / Comments**               |
| 为 if、elseif、else、catch、function、classdef 和 end 语句<br />去除不必要的分号 |                将一行中存在的多条语句强行换行                |     对连续普通语句中的顶层 `=` 和行尾 `%` 注释进行列对齐     |
| ![sample](https://image.krins.cloud/437c83b44ca0df559d45fb4363db1ce2.gif) | ![s](https://image.krins.cloud/625445fb87d5376605f48d1580d83502.gif) | ![sample](https://image.krins.cloud/83f001f67ce2db6fd96d920eafca6b1f.gif) |
