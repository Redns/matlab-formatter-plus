...
- add formatter and language-configuration support for the VS Code `octave` language id, so the extension can also format Octave documents

compatibility:

- keep the existing MATLAB registration unchanged while adding parallel `octave` registration
